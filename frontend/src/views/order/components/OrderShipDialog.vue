<template>
  <el-dialog :title="title" :visible.sync="dialogVisible" :width="isFbs ? '900px' : '520px'" top="5vh">
    ...
    <el-form v-else label-width="100px">
      ...
      <el-form-item v-if="shipForm.logistics_type === 'DBS' && shipForm.ship_provider !== 'chinapost' && shipForm.ship_provider !== 'leiyi'" label="运单号" required>
    ...
    <div slot="footer">
      ...
      <template v-else>
        <el-button v-if="shipForm.ship_provider === 'chinapost'" type="primary" :loading="shipping" @click="$emit('submit-chinapost-create')">邮政下单</el-button>
        <el-button v-if="shipForm.ship_provider === 'leiyi'" type="primary" :loading="shipping" @click="$emit('submit-sz56t-create')">雷翼下单</el-button>
        <el-button type="success" :loading="shipping" @click="$emit('submit-ship')">确认发货</el-button>
      </template>
    </div>
  </el-dialog>
</template>
